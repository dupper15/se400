                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 mb-4">
                            Cung cấp giải pháp công nghệ hiện đại và tiện lợi cho người dùng Việt Nam.
                        </p>
                    ...
                    <div>
                        ...
                        <p className="flex items-center text-gray-300 mb-2">
                            ...
                            Trường Đại học CNTT Quốc gia TP.HCM
                        </p>
                        <p className="flex items-center text-gray-300 mb-2">
                            <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="border-t border-gray-700 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-300 text-sm mb-4 md:mb-0">
                            © {new Date().getFullYear()} Demo. Tất cả các quyền được bảo lưu.
                        </p>
                        <div className="flex space-x-4">
                            <Link to="/terms" className="text-sm text-gray-300 hover:text-white">Điều khoản</Link>
                            <Link to="/privacy" className="text-sm text-gray-300 hover:text-white">Quyền riêng tư</Link>
                            <Link to="/cookies" className="text-sm text-gray-300 hover:text-white">Cookies</Link>
                        </div>
                    </div>
                </div>
            </div>
